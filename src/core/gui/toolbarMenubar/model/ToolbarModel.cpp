...
const char* TOOLBAR_INI_HEADER =
        ...
        "\n"
        " Navigation: "
        "GOTO_FIRST,GOTO_BACK,GOTO_PAGE,GOTO_NEXT,GOTO_LAST,GOTO_PREVIOUS_LAYER,GOTO_NEXT_LAYER,GOTO_TOP_LAYER,\n"
...
void ToolbarModel::save(fs::path const& filepath) const {
    ...
    if (!g_file_set_contents(filepath.c_str(), data, as_signed(len), &error)) {
